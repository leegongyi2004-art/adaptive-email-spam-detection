...
**Interpretation:** one adaptive cycle substantially improved detection of new,
AI-style/BEC campaigns while preserving normal-mail accuracy — the system measurably
*adapts* from reviewed feedback. (These synthetic sets are an illustrative, controlled
benchmark; the 81k result in §4.1 is the primary accuracy figure.)
...
4. **LLM-generated phishing benchmark:** evaluate against large public LLM-phishing
   corpora (e.g. the cross-model set of GPT/DeepSeek/LLaMA-generated emails) to report a
   detection rate on known AI-generated phishing.
...
8. scikit-learn (Pedregosa et al.), FastAPI, and DistilBERT (Sanh et al., 2019) documentation.
