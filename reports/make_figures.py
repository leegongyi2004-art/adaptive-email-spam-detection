...
if __name__ == "__main__":
    ...
    fig_2_4()
    fig_2_5()
    # Figures 3.1/3.2/3.3/4.1 are generated by make_diagrams.py (UML-style);
    # run that after this script so it does not overwrite them.
    print("Charts (1.x, 2.x) generated in", OUT, "- then run make_diagrams.py for 3.x/4.1")
